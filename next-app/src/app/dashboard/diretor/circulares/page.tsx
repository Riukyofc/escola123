...
export default function DirCirculares() {
  ...
  return (
    <div className="panel-card"><div className="panel-card-header"><div className="panel-card-title"><i className="fa-solid fa-scroll" /> Circulares da SEMED</div></div>
